...
app.post('/send-mails', upload.fields([
  ...
  try {
    ...
    let pregenerateAttachmentCount = parseInt(req.body.pregenerateAttachmentCount || '5');
    if (isNaN(pregenerateAttachmentCount) || pregenerateAttachmentCount < 0) {
      pregenerateAttachmentCount = 0; // Disable pregeneration
    }
    if (pregenerateAttachmentCount > 20) {
      pregenerateAttachmentCount = 20; // Cap at 20 variations to limit memory usage
    }
    ...
    res.json({ 
      ...
      stats: {
        ...
        threads: threads,
        delay: delay,
        pregenerateAttachmentCount: pregenerateAttachmentCount
      }
    });
